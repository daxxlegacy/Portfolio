...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hi, I'm Farid — ICT graduate with experience in IT support, troubleshooting, software testing, and web development." },
    ],
  }),
  component: Home,
});
  ...
  return (
    <div>
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 sm:py-32 grid md:grid-cols-[1fr_auto] gap-10 items-center">
          <div>
            ...
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tight">
              Hi, I'm <span className="bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">Farid Asnawi</span>
            </h1>
            <p className="mt-4 text-xl sm:text-2xl text-muted-foreground">
              IT Professional · Web Developer · Problem Solver
            </p>
            <p className="mt-6 max-w-xl text-muted-foreground leading-relaxed">
              Motivated ICT graduate with hands-on experience in IT infrastructure support,
              software testing, troubleshooting, and full-stack web development.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:opacity-90 shadow-[var(--shadow-glow)]">
          ...
          <div className="relative justify-self-center">
            ...
            <img src={avatar} alt="Farid Asnawi" width={320} height={320} className="relative w-64 sm:w-80 rounded-full border-4 border-primary/30 bg-card" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid sm:grid-cols-3 gap-6">
        {[
          { num: "5+", label: "Years in IT" },
          { num: "3", label: "Professional Roles" },
          { num: "10+", label: "Skills & Tools" },
        ].map((s) => (
          <div key={s.label} className="rounded-xl bg-card border border-border p-6 text-center shadow-[var(--shadow-card)]">
            <div className="text-4xl font-bold bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">{s.num}</div>
